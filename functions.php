...
function parea_show_randon_banner(){
	
	$banners = array(
		'<a href="http://localhost/wp-avancado/wp-content/uploads/2017/08/download.jpg"></a>',
		'<a href="https://ecommercenews.com.br/wp-content/uploads/2015/12/accesstage.png"></a>',
		'<a href="https://ecommercenews.com.br/wp-content/uploads/2017/08/Banner_Inside.jpg?pas=6666000941708232103"></a>'
	);

	$rand = rand( 0, sizeof($banners) - 1 );

	echo '<div style="float:left; margin-right:15px">'.$banners[$rand].'</div>';

}

add_action( 'parea_random_banner', 'parea_show_randon_banner' );
